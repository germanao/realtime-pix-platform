...
public sealed class RealtimeProjectionDbContextFactory : IDesignTimeDbContextFactory<RealtimeProjectionDbContext>
{
    ...
    {
        var connectionString = Environment.GetEnvironmentVariable("REALTIME_PROJECTION_MIGRATIONS_CONNECTION")
            ?? throw new InvalidOperationException(
                "Set REALTIME_PROJECTION_MIGRATIONS_CONNECTION before using EF Core design-time tooling.");
